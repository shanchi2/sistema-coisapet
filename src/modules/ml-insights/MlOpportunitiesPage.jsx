...
function ItemRow({ r, right, tags }) {
  return (
    <div className="flex items-center justify-between gap-3 bg-white border border-slate-200 hover:border-emerald-300 rounded-xl px-3.5 py-3 transition-colors">
      ...
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Oportunidades de Venda</h1>
        ...
        {tab === 'combos' && (
          <div className="bg-white border border-slate-200 rounded-2xl p-5">
            ...
            {combos === null ? (
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-2.5 mt-3">
                {combos.results.map((c, i) => (
                  <div key={i} className="flex items-center justify-between gap-3 bg-white border border-slate-200 rounded-xl px-3.5 py-3">
