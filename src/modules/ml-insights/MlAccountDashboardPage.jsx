        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-emerald-500 rounded-xl flex items-center justify-center shrink-0">
              <LayoutDashboard size={20} strokeWidth={1.5} className="text-white"/>
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={load} disabled={loading}
              className="flex items-center gap-2 px-3 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-xl disabled:opacity-60 transition-colors">
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-white border border-slate-200 rounded-xl p-5">
                <div className="flex items-center gap-2 mb-1"><DollarSign size={14} className="text-slate-400"/><p className="text-xs font-semibold text-slate-500 uppercase">Total</p></div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5">
                <div className="flex items-center gap-2 mb-1"><Sparkles size={14} className="text-slate-400"/><p className="text-xs font-semibold text-slate-500 uppercase">Orgânico (aprox.)</p></div>
                <p className="text-2xl font-bold text-emerald-600">{fmtMoney(data.organic_revenue)}</p>
                <p className="text-xs text-slate-400 mt-1">
                  {rev?.revenue && data.organic_revenue != null ? `${((data.organic_revenue / rev.revenue) * 100).toFixed(0)}% da receita` : 'Precisa de Ads pra calcular'}
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5">
                <div className="flex items-center gap-2 mb-3"><HeartPulse size={14} className="text-slate-400"/><p className="text-xs font-semibold text-slate-500 uppercase">Saúde dos anúncios</p></div>
                <p className="text-sm text-slate-500 mb-2">O diagnóstico completo (por anúncio) fica na tela dedicada — não repetimos aqui pra não sobrecarregar a API a cada abertura desse painel.</p>
                <Link to="/ml/saude" className="inline-flex items-center gap-1.5 text-sm font-medium text-emerald-600 hover:text-emerald-700">
                  Ver Saúde dos Anúncios <ArrowRight size={14}/>
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5">
                <p className="text-xs font-semibold text-slate-500 uppercase mb-3">Padrão de vendas por dia da semana</p>
