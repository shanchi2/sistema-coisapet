...
/**
 * useMaterialCategories — gerencia categorias de matéria-prima.
 * Retorna: categories, loading, create, update, remove
 */
export function useMaterialCategories() {
  ...
  async function remove(id) {
    ...
    if (error) { toast.error('Não é possível excluir — verifique se há materiais vinculados.'); throw error }
