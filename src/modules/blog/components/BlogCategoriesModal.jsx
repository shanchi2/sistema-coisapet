  ...
  return (
    <div className="border border-slate-200 rounded-xl p-4 bg-slate-50 flex flex-col gap-3">
      <div>
        ...
        <input
          className="input"
          placeholder="Ex: Cuidados, Terrários, Receitas..."
          value={name}
...
export function BlogCategoriesModal({ open, onClose }) {
  ...
  return (
    <>
      <Modal
        ...
        subtitle="Organize os posts por categoria"
        size="sm"
      ...
      <ConfirmDialog
        ...
        description="Posts vinculados a esta categoria não serão excluídos, apenas perderão a categoria."
